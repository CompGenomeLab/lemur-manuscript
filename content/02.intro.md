...
To study whether repair patterns are unique to the organism of interest we aimed to compare human and a non-human primate. 
...
Although their genome is now available, we lack an in-depth understanding of genomic features such as epigenetic maps, transcriptomes and methylomes.
...
With this motivation, we carried out a comparative study between the two primates to understand similarities and differences between their repair profiles.

...
Mouse lemur XR-seq resulted in oligomer length distribution identical to humans (Fig {@fig:fig1}B) thus indicating deep homology with human. 
...
Also, TCR is seen in the transcribed strand of the genes. 
...
In those organisms having TCR, genes have asymmetrical repair between two strands; transcribed strand (TS) is repaired more efficiently compared to nontranscribed strand (NTS) [@doi:10.1038/nrm2549;@doi:10.1038/342095a0]. 

...
In vivo excision assay results in the excised oligomers containing UV-induced lesions. (Fig {@fig:fig1}A)
...
During time course, gel images reflect more secondary products versus primary, suggesting more degraded excised oligomer with damage is observed at later time points. 
For human (NHF1) and mouse lemur the trend is similar. 
...
A small variance in oligomer lengths between in vivo excision assay and XR-seq might be due to the immediate exonuclease activity on excised oligomer for in vivo excission assay. 
XR-seq primary products are less prone to degradation possibly because of TFIIH protection of the oligomers.
...
We counted cells for each dose and drew a survival curve for lemur and human fibroblasts (Fig {@fig:fig2}A).

...
For this reason, for the organisms having TCR, genes have asymmetrical repair between two strands; TS is repaired more efficiently compared to NTS [@doi:10.1038/nrm2549;@doi:10.1038/342095a0]. 

(6-4)PP is repaired faster than CPD [@doi:10.1093/nar/gkz035; @doi:10.1073/pnas.1603388113]. 
...
CPD, on the other hand, is harder to be recognized and therefore it takes a longer time to remove CPDs in the genome. 
...
There is an apparent asymmetry between both human and mouse lemur TCR profiles relative to TSS (Fig {@fig:fig3}). 
For genes on the plus strand; repair of the minus (transcribed) strand at the TSS downstream is higher compared to plus (non-transcribed) strand. 
At the TSS upstream, the asymmetry is the opposite of the TSS downstream. 
This observation was previously explained with the bi-directional features of the promoters [@doi:10.1016/j.tig.2011.04.002].
...
Opposite strand mappings (gene:XR-seq pair as +:- or -:+) are annotated as TS (red), same strand mappings (+:+; -:-) are annotated as NTS. 
...
Although there is a clear difference in TCR rates between two species (Fig {@fig:fig3}), homologous regions of two genomes exhibited a strong repair rate correlation; R values for (6-4)PP and CPD are 0.80 and 0.72 (p=0), respectively (Fig {@fig:fig4}B).
...
Chromosomal homologous regions associations are dispersed as previously suggested [@doi:10.1186/s12915-017-0439-6].  
...
To understand what factors affect the correlation between these two highly-diverged species of primate, we questioned the correlation strength and expression levels. 
...
The strength of the correlation between two repair profiles was found to be correlated with transcription levels (Fig {@fig:fig5}).
Highly expressed regions had better repair correlation between the two species.

![ Repair rate consistency in correlation with gene expression. The transcription levels of the orthologous regions were divided into quartiles separately for human and lemur. Out of quartiles 10 bootstrapped subsamples were retrieved and for those regions repair correlation was analyzed. Correlation coefficient (R values) are represented on the y-axis; quartiles are on the x-axis.
...
For this reason, we used another human cell line, GM12878 - B-Lymphocytes to ask whether the repair profile of human fibroblast is closer to lemur fibroblast or to human lymphocyte.
We performed XR-seq for CPD only as it yields relatively high genome-wide heterogeneity compared to (6-4)PP likely its lower repaired rate compared.
...
Two replicates of CPD XR-seq samples of human lymphocytes (GM12878) were clustered as an outgroup.
...
On the other hand, even though belonging to the same organisms, completely different human cell lines have a considerable variation with respect to repair patterns.
...
![ Cell type-based consistency of repair profiles between two primates. A) Scatter plot between two human cell lines, GM18787 and NHF1, show correlation. B) Principle component analysis of 10 XR-seq samples. 
